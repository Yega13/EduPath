...
function seedDB(): DB {
  ...
  return {
    ...
    events: [
      ...
      { id: 'ev-3', title: 'FAST Foundation Research Grant', description: 'Funding grant for student-led research projects in science and technology. Up to $5,000 per team.', event_type: 'grant', organizer: 'FAST Foundation', location: 'Yerevan', is_online: false, deadline: inDays(45), link: 'https://example.com', upvote_count: 29, is_approved: true },
      { id: 'ev-4', title: 'Intro to Machine Learning — Free Course', description: 'A 6-week hands-on online course covering the fundamentals of ML with Python. Beginner friendly.', event_type: 'course', organizer: 'AUA Extension', location: null, is_online: true, deadline: inDays(7), link: 'https://example.com', upvote_count: 38, is_approved: true },
      { id: 'ev-5', title: 'Yerevan Youth Leadership Fellowship', description: 'A 3-month fellowship building leadership and project-management skills, ending in a community project.', event_type: 'fellowship', organizer: 'UNICEF Armenia', location: 'Yerevan', is_online: false, deadline: inDays(25), link: 'https://example.com', upvote_count: 33, is_approved: true },
      { id: 'ev-6', title: 'WCIT Tech Conference Yerevan', description: 'Two-day international technology conference with talks from global engineers, founders and researchers.', event_type: 'conference', organizer: 'UATE', location: 'Yerevan', is_online: false, deadline: inDays(21), link: 'https://example.com', upvote_count: 54, is_approved: true },
      { id: 'ev-7', title: 'Hands-on UX Design Workshop', description: 'A practical one-day workshop on user research, wireframing and prototyping with Figma. Laptops required.', event_type: 'workshop', organizer: 'Design Lab', location: 'Gyumri', is_online: false, deadline: inDays(9), link: 'https://example.com', upvote_count: 26, is_approved: true },
      { id: 'ev-8', title: 'Careers in AI — Panel Discussion', description: 'Industry leaders discuss building a career in artificial intelligence and machine learning. Q&A included.', event_type: 'panel', organizer: 'Armenia AI', location: null, is_online: true, deadline: inDays(5), link: 'https://example.com', upvote_count: 19, is_approved: true },
      { id: 'ev-9', title: 'Frontend Developers Meetup', description: 'Monthly community meetup for frontend developers — short talks, networking and free pizza.', event_type: 'meetup', organizer: 'JS Yerevan', location: 'Yerevan', is_online: false, deadline: inDays(3), link: 'https://example.com', upvote_count: 31, is_approved: true },
    ],
    chats: [],
    lessons: [],
    messages: [],
